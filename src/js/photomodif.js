...
//    animate.addEventListener('click', toggleAnim, false);
    ...
    easy.addEventListener('click', function() { difficulty("e") }, false);
    medium.addEventListener('click', function() { difficulty("m") }, false);
    hard.addEventListener('click', function() { difficulty("h") }, false);
